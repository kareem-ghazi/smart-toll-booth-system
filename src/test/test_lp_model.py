...
def test_lp_model():
    ...
    # Load model
    print(f"Loading LP model from {model_path}...")
    ...
    print("\n--- Starting Individual Image Inference ---")
    ...
    print(f"\nAll LP model visual results saved to {visual_results_dir}")
